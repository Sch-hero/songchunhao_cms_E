...
public interface ArticleMapper {
	 ...
	 * @return
	 */
	@Update("UPDATE cms_article set status=#{status},updated=now() WHERE id=#{articled}")
	int updateStatus(@Param("articled")Integer articled,@Param("status")int status);
	 ...
	 * @return
	 */
	@Update("UPDATE cms_article set hot=#{status},updated=now() WHERE id=#{articled}")
	int updateHot(@Param("articled")Integer articled,@Param("status")int status);
