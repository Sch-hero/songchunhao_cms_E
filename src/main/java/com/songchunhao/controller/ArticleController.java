...
import com.songchunhao.comon.CmsAssertJson;
import com.songchunhao.comon.CmsAssertView;
...
import com.songchunhao.entity.ImageBean;
...
public class ArticleController   {
	...
	public String getCommentlist(HttpServletRequest request,Integer userId,
			@RequestParam(defaultValue="1") Integer page) {
		PageInfo<Comment> comments = articleService.getCommentlist(userId, page);
